...
class MainMenu(Tk):
    def __init__(self, open_callback, save_callback, duplicate_callback, lut_callback, hist_callback, without_supersaturation_hist_callback, with_supersaturation5_hist_callback, eq_callback, negation_callback, reduce_gray_callback):
        super().__init__()
...
if __name__ == "__main__":
    ...
    menu = MainMenu(open_and_show_image, save_image, duplicate_focused_image, show_lut, cal_and_show_hist, calandshow_without_supersaturation_hist, calandshow_with_supersaturation5_hist, histogram_equalization, negation, reduce_gray_levels)
    menu.mainloop()