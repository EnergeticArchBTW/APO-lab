...
class MainMenu(Tk):
    def __init__(
            ...
            convert_many_images_to_grayscale_and_show_callback, open_and_show_images_callback, scal_callback, scal_many_img_callback,
            # lab 1
        ...
        file_menu.add_command(label="usuwanie szumu obraz binarny (sól i pieprz)", command=run_logical_operations_project_callback)
        file_menu.add_command(label="konwersja obrazu na monochromatyczny", command=convert_to_grayscale_and_show_callback)
        file_menu.add_command(label="konwersja wielu obrazów na monochromatyczny", command=convert_many_images_to_grayscale_and_show_callback)
        file_menu.add_command(label="Otwórz wiele obrazów", command=open_and_show_images_callback)
        file_menu.add_command(label="Skalowanie obrazu w %", command=scal_callback)
        file_menu.add_command(label="skalowanie wielu obrazów na raz w %", command=scal_many_img_callback)
        menubar.add_cascade(label="Projekt", menu=file_menu)

        # Menu "Lab 1"
        file_menu2 = Menu(menubar, tearoff=0)
        # lab 1
        file_menu2.add_command(label="Zad 1", state="disabled")
        ...
        file_menu2.add_command(label="Zad 2", state="disabled")
        file_menu2.add_command(label="Tablica LUT", command=lut_callback)
        file_menu2.add_command(label="Zad 3", state="disabled")
        ...
        file_menu2.add_command(label="Zad 4", state="disabled")
        ...
        file_menu3.add_command(label="Zad 1", state="disabled")
        ...
        file_menu3.add_command(label="Zad 2", state="disabled")
        ...
        file_menu3.add_command(label="Zad 3", state="disabled")
        ...
        file_menu3.add_command(label="Zad 4", state="disabled")
        file_menu3.add_command(label="filtracja medianowa", command=run_median_filter_callback)
        file_menu3.add_command(label="Zad 5", state="disabled")
        ...
        file_menu4.add_command(label="Zad 1", state="disabled")
        ...
        file_menu4.add_command(label="Zad 2", state="disabled")
        ...
        file_menu5.add_command(label="Zad 1", state="disabled")
        file_menu5.add_command(label="wyznaczanie momentu, pola powierzchni i współczynniki kształtu", command=designation_callback)
        file_menu5.add_command(label="Zad 2", state="disabled")
        file_menu5.add_command(label="segmentacja z GraphCut", command=run_grabcut_callback)
        menubar.add_cascade(label="Lab 4", menu=file_menu5)
...
if __name__ == "__main__":
    ...
    globals_var.root = MainMenu(
        # projekt
        averaging_photos, run_logical_operations_project, convert_to_grayscale_and_show, convert_many_images_to_grayscale_and_show, 
        open_and_show_images, scal, scal_many_img,
        # lab 1
